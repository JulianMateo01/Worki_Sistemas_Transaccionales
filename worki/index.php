 				...
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
 					...
 					<div style="border:solid thin #aaa; padding: 10px;background-color: white;">
 						...
 						<form method="post" enctype="multipart/form-data">
	 						...
	 						<textarea name="post" placeholder="Postea lo que piensas"></textarea>
	 				...
	 				<div id="post_bar">
 						...
 						<?php 
	 					 ...
	 					 ?>
	 					 <a href="<?= $pg['next_page'] ?>">
	 					 <input id="post_button" type="button" value="Pagina Siguiente" style="float: right;width:150px;">
	 					 </a>
	 					 <a href="<?= $pg['prev_page'] ?>">
	 					 <input id="post_button" type="button" value="Pagina Anterior" style="float: left;width:150px;">
	 					 </a>
	 				</div>
