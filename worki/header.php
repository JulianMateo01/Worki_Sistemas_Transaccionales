...
<div id="blue_bar">
	<form method="get" action="search.php">
		<div style="width: 800px;margin:auto;font-size: 30px;">
			...
			<a href="index.php" style="color: white;">Worki</a> 
			...
			<?php if(isset($USER)): ?>
				...
				<a href="logout.php">
				<span style="font-size:11px;float: right;margin:10px;color:white;">Salir</span>
				</a>
				...
				<span style="display: inline-block;position: relative;">
					...
					?>
				<label class="switch">
					<input type="checkbox" id="slidernocturno">
					<span class="slider" for="flexSwitchCheckDefault">Color</span>
				</label>
					<?php if($notif > 0): ?>
