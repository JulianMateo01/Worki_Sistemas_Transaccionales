...
<!DOCTYPE html>
	...
	<body style="font-family: tahoma; background-color: #fff0f0;">
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<span style="font-size: 12px;">
					...
					<?php if(i_own_content($user_data)):?>
						...
						<a onclick="show_change_profile_image(event)" style="text-decoration: none;color:#f0f;" href="change_profile_image.php?change=profile">Cambiar imagen de perfil</a> | 
						<a onclick="show_change_cover_image(event)" style="text-decoration: none;color:#f0f;" href="change_profile_image.php?change=cover">Cambiar Portada</a>
				...
				<br>
					<div style="font-size: 20px;color: black;">
						...
						<a href="like.php?type=user&id=<?php echo $user_data['userid'] ?>">
							<input id="post_button" type="button" value="Seguir <?php echo $mylikes ?>" style="margin-right:10px;background-color: #9b409a;width:auto;">
						</a>
				...
				<a href="profile.php?section=about&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons">Sobre</div></a>
				<a href="profile.php?section=followers&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons">Seguidores</div></a>
				<a href="profile.php?section=following&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons">Seguidos</div></a>
				<a href="profile.php?section=photos&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons">Fotos</div></a>
				
				<?php 
					if($user_data['userid'] == $_SESSION['mybook_userid']){
						echo '<a href="profile.php?section=settings&id='.$user_data['userid'].'"><div id="menu_buttons">Configuracion</div></a>';
					}
				?>
			</div>
