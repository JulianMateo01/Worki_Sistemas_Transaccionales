...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-11-2021 a las 23:29:18
...
--
-- Estructura de tabla para la tabla `content_i_follow`
--
...
--
-- Volcado de datos para la tabla `content_i_follow`
--
...
(1, 'user', '[{\"userid\":\"43452924198233985\",\"date\":\"2021-01-14 13:41:33\"},{\"userid\":\"45780258653\",\"date\":\"2021-01-25 09:18:17\"},{\"userid\":\"7116\",\"date\":\"2021-11-16 22:53:44\"}]', 204306973626090829, '[{\"userid\":\"43452924198233985\",\"date\":\"2021-01-19 23:47:38\"}]'),
...
(11, 'post', '[{\"userid\":\"7116\",\"date\":\"2021-11-16 22:12:44\"}]', 3637528219358658600, ''),
(12, 'user', '', 7116, '[{\"userid\":\"204306973626090829\",\"date\":\"2021-11-16 22:53:44\"}]');
...
(28, 7116, 'like', 3637528219358658600, 7116, 'post', '2021-11-16 22:12:44'),
(29, 7116, 'follow', 204306973626090829, 204306973626090829, 'profile', '2021-11-16 22:53:44');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `notification_seen`
--
...
--
-- Volcado de datos para la tabla `notification_seen`
--
...
(28, 470756820898, 'Sistemas Transaccionales , un 5 para el grupo 1', '', 0, 0, 0, 0, '2021-11-16 16:09:49', 7116, 0, 0, '[]'),
(29, 3637528219358658600, 'Sistemas transaccionales', '', 0, 0, 0, 0, '2021-11-16 16:12:29', 7116, 1, 0, '[]'),
(30, 8566488059221183, 'PRUEBA', '', 0, 0, 0, 0, '2021-11-16 16:24:51', 7116, 0, 0, '[]'),
(31, 57066767202921737, 'PRUEBA 2', '', 0, 0, 0, 0, '2021-11-16 16:25:16', 7116, 0, 0, '[]'),
(32, 206395524, 'prueba', '', 0, 0, 0, 0, '2021-11-16 19:03:00', 38215438, 0, 0, '[]'),
(33, 25110332, 'prueba 3', '', 0, 0, 0, 0, '2021-11-16 19:48:30', 7116, 0, 0, '[]'),
(34, 411206890913086, 'prueba 4', '', 0, 0, 0, 0, '2021-11-16 19:48:53', 7116, 0, 0, '[]');
...
(2, 204306973626090829, 'Mary', 'Phiri', 'Female', 'uploads/204306973626090829/y68VT8ZQ17K3pUc.jpg', 'uploads/204306973626090829/53Djo3ipQL2QofM.jpg', 0000, 0, 'maryphiri@yahoo.com', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'mary.phiri', 3, '', 'mary'),
...
(6, 7116, 'Julian', 'Jimenez', 'Male', '', '', 0000, 0, 'jimenez.julian.mateo@gmail.com', '61646f640c42bf21f46b9a85833711b40cace3e5', 'julian.jimenez', 0, 'Julian Mateo Jimenez Sanchez', 'julianjimenez'),
(7, 38215438, 'Pepe', 'Juarez', 'Mascul', '', '', 0000, 0, 'p.b@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'pepe.juarez', 0, 'pepe juarez', 'pepejuarez');
...
--
-- Indices de la tabla `content_i_follow`
--
...
--
-- Indices de la tabla `notification_seen`
--
...
--
-- AUTO_INCREMENT de la tabla `content_i_follow`
--
ALTER TABLE `content_i_follow`
...
--
-- AUTO_INCREMENT de la tabla `notification_seen`
--
ALTER TABLE `notification_seen`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
