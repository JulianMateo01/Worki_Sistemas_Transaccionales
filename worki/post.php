	...
	<div id="post">
		...
		?>
		<a onclick="like_post(event)" href="like.php?type=post&id=<?php echo $ROW['postid'] ?>">Me gusta<?php echo $likes ?></a> . 
		...
		<a href="single_post.php?id=<?php echo $ROW['postid'] ?>">Comentar<?php echo $comments ?></a> . 
